...
export function mergeEnrichment(spreads, enr) {
  ...
  return spreads.map((s) => {
    ...
    return {
      ...
      causeEffect: typeof e.causeEffect === 'string' ? e.causeEffect : s.causeEffect || '',
      expansionPhrase: typeof e.expansionPhrase === 'string' ? e.expansionPhrase : s.expansionPhrase || '',
      lifeConnectionHint: typeof e.lifeConnectionHint === 'string' ? e.lifeConnectionHint : s.lifeConnectionHint || '',
