...
${bookMapBlock}CANDIDATE SCENES (pick 2-3 across the whole conversation; you need not use them all — "cause/effect" and "could connect to her life" notes, where present, are optional material especially useful for today's theme or for Stage 3 later, not something to force into every scene):
${sceneLines}
